...
<a href="http://hoidapnghiquyet.tuyenquang.gov.vn" target="_blank" class="app-card"><div class="app-icon" style="background:radial-gradient(circle, #C8102E 40%, #a00d25 100%); width:60px; height:60px; border-radius:50%; display:flex; align-items:center; justify-content:center; margin: 0 auto 10px auto; border:3px solid #ffcc00; box-shadow:0 3px 6px rgba(0,0,0,0.2);"><span style="color:#ffcc00; font-size:35px; line-height:1;">☭</span></div><div class="app-title">Hỏi đáp Nghị quyết</div><div class="app-desc">Chatbot AI hỗ trợ tra cứu, giải đáp thông tin về Nghị quyết Đại hội đại biểu Đảng bộ tỉnh nhiệm kỳ 2025-2030.</div><div class="access-btn">🚀 Truy cập ngay</div></a>
