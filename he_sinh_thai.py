...
# ==========================================
# KHU VỰC CHỨA 7 ỨNG DỤNG (ĐÃ CẬP NHẬT)
# ==========================================
...
<div class="ecosystem-grid">
    ...
    <a href="https://quan-ly-ho-so-tgdv.streamlit.app/" target="_blank" class="app-card">
        ...
        <div class="app-desc">Hệ thống số hóa hồ sơ nhân sự, tự động cập nhật lịch sử công tác, lương và xuất Sơ yếu lý lịch chuẩn A4.</div>
        <div class="access-btn">🚀 Truy cập ngay</div>
    </a>
    
    <a href="https://diemtinhangngaytgdv.streamlit.app/" target="_blank" class="app-card">
        <div class="app-icon">🌐</div>
        <div class="app-title" style="color: #C8102E;">Điểm tin Báo chí</div>
        <div class="app-desc">Tổng hợp tin bài tự động 24/7 từ báo chính thống: Thời sự, Quốc tế, Dư luận xã hội và Dân vận khéo.</div>
        <div class="access-btn" style="background-color: #C8102E; color: white;">🚀 Truy cập ngay</div>
    </a>
    ...
    <a href="https://tracuuluong-tgdvtq.streamlit.app/" target="_blank" class="app-card">
        <div class="app-icon">🤖</div>
        <div class="app-title">AI Tra cứu Lương</div>
        <div class="app-desc">Trợ lý ảo thông minh hỗ trợ tra cứu tự động thông tin lương, phụ cấp và chế độ của cán bộ, công chức.</div>
        <div class="access-btn">🚀 Truy cập ngay</div>
    </a>
    ...
    <a href="https://dangkysovanbantgdv.streamlit.app/" target="_blank" class="app-card">
        <div class="app-icon">📑</div>
        <div class="app-title">Đăng ký Số VB</div>
        <div class="app-desc">Hệ thống cấp số tự động, quản lý sổ văn thư và thống kê văn bản đi chuẩn thể thức Ban TGDV.</div>
        <div class="access-btn">🚀 Truy cập ngay</div>
    </a>
</div>
"""
