...
# Hàm lấy Logo Cờ Đảng (Mới bổ sung cho sếp)
...
<style>
    ...
    .hero-banner h1 {{ font-size: 32px; font-weight: 900; margin: 10px 0 5px 0; text-transform: uppercase; letter-spacing: 1px; color: white !important;}}
    .hero-banner p {{ font-size: 16px; opacity: 0.9; margin: 0; font-weight: 500; color: white !important;}}
    ...
    .app-icon {{ font-size: 35px; margin-bottom: 10px; text-align: center; display: flex; justify-content: center; align-items: center;}}
...
# Xử lý Logo Cờ Đảng cho ứng dụng Nghị quyết
codang_data = get_codang_base64()
if codang_data:
    icon_codang = f'<img src="data:image/jpeg;base64,{codang_data}" style="height: 45px; width: 65px; object-fit: cover; border-radius: 4px;">'
else:
    icon_codang = "🇻🇳"
...
<a href="https://diemtinhangngaytgdv.streamlit.app/" target="_blank" class="app-card"><div class="app-icon">🌐</div><div class="app-title">Điểm tin Báo chí</div><div class="app-desc">Tổng hợp tin bài tự động 24/7 từ báo chính thống: Thời sự, Quốc tế, Dư luận xã hội và Dân vận khéo.</div><div class="access-btn">🚀 Truy cập ngay</div></a>
